...
En este campo, las categorías _Construccion_ e _Industria_ apenas tienen 14 y 13 apariciones, respectivamente. Por ello, dado que solo hay que agrupar dos categorías con poca representación (a diferencia de las CCAA donde teníamos 19), lo agruparemos con la categoría con mayor representación: _Otro_:
...
```{r}
impVariablesLog(modelo.final.bin, "varObjBin", data_train.bin)[c(1:3), ]
```
